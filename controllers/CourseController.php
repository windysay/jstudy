...
class CourseController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['index','teachers','timetable','search','download','file-download'],
                        'allow' => true,
                    ],
                ],
            ],
    ...
    public function actionSearch($date=null,$time=null){  //time 1上午  2下午 3晚上
		switch ($time){
			...
			case 3: $time_begin=$date.' 19:00:00';$time_end=$date.' 23:59:59';break;
			default:$time_begin=$date.' 07:00:00';$time_end=$date.' 23:59:59';break;
		}
