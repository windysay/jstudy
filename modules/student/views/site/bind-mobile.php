...
<div class="student-bind-mobile form_basic phoneCode_basic">
	 <p class="form_top_title"><?= $title ?></p>

        <p class="top_t1">现在，请您填写新手机号码</p>
        
        <?php $form = ActiveForm::begin(); ?>
        
	    <?= $form->field($model, 'mobile',['enableAjaxValidation' => true])->textInput(['maxlength' => 11,'value'=>'']) ?>
        ...
        <div class="form-group clearfix">
         ...
         <div class="form-group submit_group">
	        <?= Html::submitButton('立即绑定', ['class'=>'btn btn-success my_btn']) ?>
