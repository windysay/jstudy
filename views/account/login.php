...
$this->title = '会员登录';
?>
<div class="account-login account_basic">
   ...
   <div class="main clearfix">
        ...
        <div class="right_box">
            <p class="title_p">会员登录</p>
            <?php $form = ActiveForm::begin(['id' => 'login-form']);?>
                <?= $form->field($model, 'username')->textInput(['placeholder'=>"用户名/邮箱",'maxlength'=>20]) ?>
				...
				<div class="form-group loginform_rememberme clearfix">
				    ...
				    <p class="forget_pswd"><a class="color_blue"  href="<?=Url::toRoute('account/forget-userpwd-email'); ?>">忘记密码？</a></p>
				</div>
