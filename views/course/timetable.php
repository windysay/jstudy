	 			...
	 			<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							...
							<a class="time_block bespeaked" href="JavaScript::void(0)" style="cursor:default;">已预约</a>
							<?php elseif($class->status==4):  //已完成?>
							<a class="time_block completed" href="JavaScript::void(0)" style="cursor:default;">已结束</a>
							<?php elseif($class->status==1):  //可预约?>
							<a class="time_block choosed" href="JavaScript::void(0)" data-id="<?= $class['id'] ?>"  title='点击预约' data-toggle='tooltip' data-placement='top'>可预约</a>
							<?php endif;?>
						</td>
						<?php endforeach;?>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<?php elseif($class->status==0):  //管理员已删除?>
								...
								<?php endif;?>
							<?php elseif($class->status==2||$class->status==3):  //已预约 //上课中 ?>
							<a class="time_block bespeaked" href="JavaScript::void(0)" data-id="<?= $class['id'] ?>"  style="cursor:default;">已预约</a>
							<?php elseif($class->status==4):  //已完成?>
							<a class="time_block completed" href="JavaScript::void(0)" style="cursor:default;">已结束</a>
							<?php elseif($class->status==1):  //可预约?>
							<a class="time_block choosed" href="JavaScript::void(0)" data-id="<?= $class['id'] ?>"  title='点击预约' data-toggle='tooltip' data-placement='top'>可预约</a>
